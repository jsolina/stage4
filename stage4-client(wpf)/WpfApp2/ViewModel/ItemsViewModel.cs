...
namespace WpfApp2.ViewModel
{
    public class ItemsViewModel : INotifyPropertyChanged
    {
        ...
        public ItemsViewModel(IItem _dbContext, TaskListModel _selectedRowTask)
        {
        ...
        public void GetData()
        {
            ItemModels = dbContext.FindByFK(selectedRowTask.IdTask);
        }
        ...
        {
            ItemModelSelectedRow = dbContext.FindById(Convert.ToInt32(o));
            dbContext.Remove(Convert.ToInt32(o));
